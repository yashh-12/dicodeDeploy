...
function Rooms() {
    ...
    const [rooms, setRooms] = useState(roomsData.data || []);
        ...
        <div className="p-6 text-white flex flex-col gap-6">
                ...
                <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
                    {rooms.map((room) => (
                        ...
                        >
                            ...
                            >
                                <h2 className="text-lg font-semibold text-blue-200 truncate">{room.name}</h2>
                            ...
                            <button
                                ...
                                title="Delete Room"
                            >
                                <FaTrashAlt className="text-blue-400 group-hover:text-red-400 transition" size={16} />
            ...
            >
                <div className="bg-[#101010] border border-blue-400/20 rounded-3xl p-6 w-[90%] sm:w-full max-w-md shadow-[0_0_40px_#3b82f6aa] text-white">
                    <h2 className="text-2xl font-semibold text-blue-300 mb-4">Create a New Room</h2>
